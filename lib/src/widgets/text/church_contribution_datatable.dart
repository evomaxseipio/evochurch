...
class ChurchContributionDatatable extends HookWidget {
  final List<ChurchCollectionList> collectionTransaction;
  const ChurchContributionDatatable(this.collectionTransaction, {super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final contribution = useState<List<ChurchCollectionList>>([]);
    ...
    void updatePaginationIndices(
        List<ChurchCollectionList> contributionList,
  ...
  Widget buildDataTable(
      ...
      List<ChurchCollectionList> contribution,
      int startIndex,
      int endIndex) {
  ...
  List<DataRow2> buildTableRows(BuildContext context,
      List<ChurchCollectionList> contribution, int startIndex, int endIndex) {
  ...
  Widget buildSearchBar(
    ...
    return Row(
      children: [
        ...
        EvoButton(
          hoverColor: EvoColor.primary.withOpacity(0.9),
          text: 'Add Tithes',
          onPressed: () {
        ...
        EvoButton(
            ...
            onPressed: () async {
              try {
                // Call the export service to export data to Excel
                // only if web
                if (kIsWeb) {
