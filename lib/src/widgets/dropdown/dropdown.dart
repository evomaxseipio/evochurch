...
class EvoDropdownButton<T> extends StatefulWidget {
  ...
  @override
  State<EvoDropdownButton<T>> createState() => _EvoDropdownButtonState<T>();
}

class _EvoDropdownButtonState<T> extends State<EvoDropdownButton<T>>
  ...
  @override
  void didUpdateWidget(EvoDropdownButton<T> oldWidget) {
